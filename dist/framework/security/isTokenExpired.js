System.register(["./../helpers/statusCodes"], function (exports_1, context_1) {
    "use strict";
    ...
    var get, jwt, ApolloError, statusCodes_1;
    var __moduleName = context_1 && context_1.id;
    function default_1(jwtToken) {
        return __awaiter(this, void 0, void 0, function () {
            var decoded, expireDate, current, expireDateSeconds, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4, jwt.decode(jwtToken, get(process, 'env.JWT_SECRET', ''))];
                    case 1:
                        decoded = _a.sent();
                        expireDate = decoded.expireDate;
                        current = +new Date();
                        expireDateSeconds = expireDate * 1000;
