System.register([], function (exports_1, context_1) {
    ...
    var _a, camelCase, upperFirst, join;
    ...
    function default_1(rootDirectory) {
        ...
        predefinedModules.forEach(function (name) { return __awaiter(_this, void 0, void 0, function () {
            var filePath, content, queries, mutations;
            return __generator(this, function (_a) {
                filePath = join(__dirname, "../../framework/predefinedModules", name, "resolvers.ts");
                content = require(filePath)["default"];
                queries = content.queries;
                mutations = content.mutations;
                output.Query = __assign({}, output.Query, queries);
                output.Mutation = __assign({}, output.Mutation, mutations);
                delete content['queries'];
                delete content['mutations'];
                output = __assign({}, output, content);
                return [2];
            });
        }); });
        return output;
