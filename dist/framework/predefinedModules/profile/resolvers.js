System.register(["./validations", "./../../../framework/dynamic/index", "./../../../framework/dynamic/allModels", "./../../../framework/database/relateResolver"], function (exports_1, context_1) {
    ...
    var validations_1, index_1, allModels_1, relateResolver_1, userModel, profileModel, profileResolver;
    ...
    return {
        ...
        execute: function () {
            ...
            profileResolver = index_1["default"].resolvers({
                moduleName: 'Profile',
                validations: {
            ...
            exports_1("default", {
                    ...
                    user: function (profile) {
                        return __awaiter(this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4, relateResolver_1["default"](userModel, profile, 'user')];
                ...
                queries: __assign({}, index_1["default"].loader("Profile", profileResolver).queries),
                mutations: __assign({}, index_1["default"].loader("Profile", profileResolver).mutations)
            });
        }
    };
});
