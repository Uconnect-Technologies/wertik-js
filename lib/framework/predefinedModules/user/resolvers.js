...
let { userModel, profileModel, userRoleModel, userPermissionModel } = allModels_1.default;
...
exports.default = {
    ...
    queries: {
        ...
        me: (_, args, context, info) => __awaiter(this, void 0, void 0, function* () { return context.user; })
    },
    mutations: {
