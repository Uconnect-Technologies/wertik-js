    ...
    Role: {
        permissions(role) {
            return __awaiter(this, void 0, void 0, function* () {
                return yield relateResolver_1.default(rolePermissionsModel, role, 'permission', true);
            });
        }
    },
    mutations: Object.assign({}, index_1.default.loader("Role", roleResolver).mutations),
    queries: Object.assign({}, index_1.default.loader("Role", roleResolver).queries)
};
