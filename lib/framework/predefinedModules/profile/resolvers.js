    ...
    Profile: {
        user(profile) {
            return __awaiter(this, void 0, void 0, function* () {
                return yield relateResolver_1.default(userModel, profile, 'user');
            });
        }
    },
    queries: Object.assign({}, index_1.default.loader("Profile", profileResolver).queries),
    mutations: Object.assign({}, index_1.default.loader("Profile", profileResolver).mutations),
};
