...
exports.default = {
    queries: {
        forgetPasswordView: (_, args, g) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (!forgetPassword) {
                    return new ApolloError("Token expired or not found.", statusCodes_1.default.NOT_FOUND.number);
                }
    ...
    mutations: {
        requestPasswordReset: (_, args, g) => __awaiter(this, void 0, void 0, function* () {
            ...
            let { success } = v;
            if (!success) {
                return new ApolloError("Validation Errors", statusCodes_1.default.BAD_REQUEST.number, { list: v.errors });
            }
            try {
        ...
        resetPassword: (_, args, g) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                let forgetPassword = yield forgetPasswordModel.findOne({ token: args.token });
                if (!forgetPassword) {
                    return new ApolloError("Token Expired", statusCodes_1.default.NOT_FOUND.number);
                }
                let user = yield userModel.findOne({ email: forgetPassword.email });
                if (!forgetPassword) {
                    return new ApolloError("User not foundd", statusCodes_1.default.NOT_FOUND.number);
                }
