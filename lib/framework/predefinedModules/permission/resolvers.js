...
exports.default = {
    Subscription: index_1.default.loader("Role", permissionResolver).subscriptions,
    queries: index_1.default.loader("Permission", permissionResolver).queries,
    mutations: index_1.default.loader("Permission", permissionResolver).mutations
};
