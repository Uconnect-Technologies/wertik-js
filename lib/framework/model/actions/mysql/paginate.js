...
function default_1(model, args = {}, requestedFields = []) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (totalFilters > 0) {
            list = yield model.findAndCountAll(Object.assign({ offset: offset, limit: limit, where: convertedFilters }, attributesObject));
        }
        else {
            list = yield model.findAndCountAll(Object.assign({ offset: offset, limit: limit }, attributesObject));
        }
        return {
            filters,
