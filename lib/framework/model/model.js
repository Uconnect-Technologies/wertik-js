...
class Model {
    ...
    create(args) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let fakeResponse = yield create(this.model, args, '');
                fakeResponse.successMessageType = "Success";
    ...
    update(args) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let response = yield update(this.model, args);
    ...
    view(args) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let response = yield view(this.model, args);
                if (!response) {
                    return null;
                }
                response.successMessageType = "Success";
    ...
    findOne(args) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let response = yield findOne(this.model, args);
                if (!response) {
                    return null;
                }
                response.successMessageType = "Success";
    ...
    paginate(args) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let response = yield paginate(this.model, args);
                return response;
            }
            catch (e) {
                return internalServerError_1.default(e);
