...
exports.generateListTypeForModule = exports.generateModuleSearchShema = exports.generateCrudResolvers = exports.generateMutationsCrudSchema = exports.generateSubscriptionsCrudResolvers = exports.getSubscriptionConstants = exports.generateMutationsCrudSubscriptionSchema = exports.generateQueriesCrudSchema = void 0;
...
exports.generateCrudResolvers = (module, pubsub, configuration) => {
    ...
    const beforeBulkDelete = lodash_1.get(configuration, `events.graphql.${module.name}.beforeBulkDelete`, null);
    const afterBulkDelete = lodash_1.get(configuration, `events.graphql.${module.name}.afterBulkDelete`, null);
    const beforeBulkCreate = lodash_1.get(configuration, `events.graphql.${module.name}.beforeBulkCreate`, null);
    const afterBulkCreate = lodash_1.get(configuration, `events.graphql.${module.name}.afterBulkCreate`, null);
    const beforeBulkUpdate = lodash_1.get(configuration, `events.graphql.${module.name}.beforeBulkUpdate`, null);
    const afterBulkUpdate = lodash_1.get(configuration, `events.graphql.${module.name}.afterBulkUpdate`, null);
    // R
    const beforeList = lodash_1.get(configuration, `events.graphql.${module.name}.beforeList`, null);
    const afterList = lodash_1.get(configuration, `events.graphql.${module.name}.afterList`, null);
    const beforeView = lodash_1.get(configuration, `events.graphql.${module.name}.beforeView`, null);
    const afterView = lodash_1.get(configuration, `events.graphql.${module.name}.afterView`, null);
