...
function default_1(options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const apollo = new ApolloServer(Object.assign({ typeDefs: modules.schema, resolvers: Object.assign(Object.assign({}, modules.resolvers), { JSON: graphql_type_json_1.default, JSONObject: graphql_type_json_1.GraphQLJSONObject }), context: ({ req, res, connection }) => __awaiter(this, void 0, void 0, function* () {
                let cxt = {
                    wertik: {
                        database: database,
                        auth: {
