...
const listUserPermissions_1 = __importDefault(require("../security/listUserPermissions"));
const primaryKey_1 = __importDefault(require("../helpers/primaryKey"));
const isActionAllowed_1 = __importDefault(require("../security/isActionAllowed"));
  ...
  `;
    const server = new ApolloServer({
        ...
        context: (req) => __awaiter(this, void 0, void 0, function* () {
            let authorization = yield validateAccessToken_1.default(req);
            ...
            let isAllowed = yield isActionAllowed_1.default(permissions, "listUser");
            if (!isAllowed) {
