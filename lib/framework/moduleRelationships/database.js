...
exports.applyRelationshipSql = (module, tables) => {
    ...
    if (relationships) {
        ...
        Object.keys(oneToOne).forEach((key) => {
            ...
            if (relationshipInfo.constructor === Array) {
                relationshipInfo.forEach((relationshipInfoItem) => {
                    currentModel.hasOne(foreignModel, Object.assign({ as: relationshipInfoItem.graphqlName, foreignKey: relationshipInfoItem.foreignKey, sourceKey: relationshipInfoItem.relationColumn }, lodash_1.get(relationshipInfoItem, "options", {})));
                });
            }
            else {
                currentModel.hasOne(foreignModel, Object.assign({ as: relationshipInfo.graphqlName, foreignKey: relationshipInfo.foreignKey, sourceKey: relationshipInfo.relationColumn }, lodash_1.get(relationshipInfo, "options", {})));
            }
        });
    }
};
