...
exports.GraphQLModuleRelationMapper = void 0;
...
exports.GraphQLModuleRelationMapper = (module) => {
    ...
    if (relationships) {
        let oneToOne = lodash_1.get(relationships, "oneToOne", {});
        let belongsTo = lodash_1.get(relationships, "belongsTo", {});
        oneToOne = Object.assign(Object.assign({}, oneToOne), belongsTo);
